/*
we are using masks example here 
*/
#include <iostream>
...
//here each bool is 1 byte memory consumption 
...
//this is better as version as it only consumes 1 byte vs above which is 1byte per bool
