/*
   ...
   ***************************
    ...
    Funtion use an area in memory called the 'function call stack' //for graphical understanding watch video "011 How Function call works" and "13 Recursive Function"
   ...
   -Stack Frame or Activation Record
        ...
        -Each time a function is called we create an new activation record and push on stack
        -When a function terminates we pop the activation record and return
        -Local variable and function parameters are allocated on the stack
