...
Base cost $2.50
If package volume is greater that 100 cubic inches there is a 10% surcharge
If package volume is greater than 500 cubic inches there is a 25% surcharge

*/

#include<iostream>
#include<iomanip>   // used for decimal value precision to a specific digits
using namespace std;
...
int main() {
    ...
    cout<<"Enter length, width and height of the package seprate by spaces: ";
    ...
    if(length > max_dimension_length || width > max_dimension_length || height > max_dimension_length) {
        ...
        cout<<fixed<<setprecision(2);   //uses the #include<iomanip> for decimal precision
