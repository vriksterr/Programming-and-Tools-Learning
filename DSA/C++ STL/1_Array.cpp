...
int main(){
    ...
    cout<<".begin() Starting point of the array-> "<<stl_style_array.begin()<<endl;
    cout<<".end() Ending point of the array-> "<<stl_style_array.end()<<endl;
    //rbegin() and rend() wont print directly look into it some operator overloading might be required
