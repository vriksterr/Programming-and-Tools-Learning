...
async def addtor(ctx):
    ...
    #em.add_field(name='**Example directories**', value='''C:\Users\<username>\Downloads D:\TorrentDownloads\MyCollection''')
...
async def checktor(ctx):
    ...
    #Sem.add_field(name='**Syntax**', value='!checktor <torrent hash>')
